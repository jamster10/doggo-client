...
const Sidepanel = ({children, searchSettings, errorHandler, enableSearch, results, beginSearch, handleLogin, savePlace, myPlaces, getMyPlaces, handleListeners}) => {
  ...
  <div className="Sidepanel">
    ...
    <Switch>
      <Route
        exact
        path={'/'}
        render={() => <SearchView errorHandler={errorHandler} searchSettings={searchSettings} enableSearch={enableSearch} savePlace={savePlace} beginSearch={beginSearch} results={results}  handleListeners={handleListeners}/>}
      />
      <Route
        exact
        path={'/myplaces'}
        render={() => <MyPlaces errorHandler={errorHandler} toggleSavePlace={savePlace} myPlaces={myPlaces} getMyPlaces={getMyPlaces}/>}
      />
      <Route
        exact
        path={'/login'}
